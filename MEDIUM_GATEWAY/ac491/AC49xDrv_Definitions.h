...
/*******************************************/
	...
	#define AC49X_NUMBER_OF_CHANNELS	            16
...
typedef enum  
	...
	CHANNEL_CONFIGURATION_OP_CODE__G711_WB_INITIALIZATION=50,
...
typedef enum 
	{
	RTCP_XR_EVENTS_MODE__DISABLE_VOICE_QUALITY_STATISTICS,
...
typedef enum
	...
	MODEM_RELAY_STATUS_OR_EVENT_INDEX__DEBUG_STATUS,
	MODEM_RELAY_STATUS_OR_EVENT_INDEX__DATA_PAMP_STATUS,
...
typedef struct
    ...
    Tac49xLawSelect                                 LawSelect;                   /*!< PCM serial port A-law / Mu-law / Linear configuration.*/
...
typedef struct
	...
	U8						                    RemoteRate;          /*!< AMR/AMR-WB Remote Rate. This parameter is used to set the rate of the remote side at initialization. This field is enabled according to RemoteRateEnable field. Refer to the table <A HREF="AMR and Wide-Band AMR Rates.html">AMR and AMR-WB rates </A>. Default = 7 (AMR 12.2 kbps \AMR-WB 23.05 kbps).*/
...
typedef  struct                     
    ...
    /**
     * @defgroup Tac49xMicrosoftRtaInitializationAttr Tac49xMicrosoftRtaInitializationAttr
     * @ingroup CHANNEL_CFG_STRUCTURES
     * @brief
     * Defines the function ::Ac49xMicrosoftRtaInitializationConfiguration parameters.
     * @{
     */

    /**
     * <BR>
     * This structure defines the function ::Ac49xMicrosoftRtaInitializationConfiguration parameters.
     */
typedef struct                     
    {
...
typedef struct                 
    ...
    } Tac49xExtendedIbsStringAttr, Tac49xExtendedIbsString_Format0_Attr;          
