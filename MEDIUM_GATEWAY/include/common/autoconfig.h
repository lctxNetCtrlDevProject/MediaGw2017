#ifndef _INC_CC_AUTOCONFIG_H
#define _INC_CC_AUTOCONFIG_H


/* Define to 1 if internal poll should be used. */
/* #undef INC_POLL_COMPAT */
...
#define PACKAGE_NAME "INC_AG"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "INC_AG 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "INC_AG"
