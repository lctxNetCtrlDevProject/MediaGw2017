...
/*! Input ready */
#define INC_IO_IN 	POLLIN
/*! Output ready */
#define INC_IO_OUT 	POLLOUT
/*! Priority input ready */
#define INC_IO_PRI	POLLPRI

/* Implicitly polled for */
/*! Error condition (errno or getsockopt) */
#define INC_IO_ERR	POLLERR
/*! Hangup */
#define INC_IO_HUP	POLLHUP
/*! Invalid fd */
#define INC_IO_NVAL	POLLNVAL

/*
 * An INC_CC IO callback takes its id, a file descriptor, list of events, and
...
typedef int (*inc_io_cb)(int *id, int fd, short events, void *cbdata);
#define INC_IO_CB(a) ((inc_io_cb)(a))
 ...
 */
int inc_io_remove(struct io_context *ioc, int *id);
...
/*! Restores TTY mode */
/*
 * Call with result from previous inc_hide_password
 */
int inc_restore_tty(int fd, int oldstatus);
